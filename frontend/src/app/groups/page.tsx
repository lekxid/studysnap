...
export default function GroupsPage() {
  ...
  if (!ready) return <div className="min-h-screen bg-[#0b0f14] text-white p-6">Checking authentication...</div>;
    ...
    <AppShell title="Groups" subtitle="Collaborate with friends, share notes, and study together">
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-white/[0.07] bg-[#12181e] p-6">
          <h3 className="text-xl font-semibold text-[#ece8da]">Study Groups</h3>
        ...
        <div className="rounded-2xl border border-white/[0.07] bg-[#12181e] p-6">
          <h3 className="text-xl font-semibold text-[#ece8da]">Leaderboard</h3>
          <div className="mt-4 space-y-3 text-white/80">
